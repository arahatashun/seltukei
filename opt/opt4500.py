...
RIVET_DICT = {4: 3.175, 5: 3.96875, 6: 4.76258}  # リベット径[mm]の候補辞書(keyは呼び番号)
DIVISION_LIST = [2]  # webの分割数の候補リスト
# STIFFENER_THICKNESS_LIST = [1.80, 2.03, 2.29, 2.54, 3.18]  # 適当
FLANGE_THICKNESS_LIST = [1.6 + i * 0.5 for i in range(10)]  # 適当
STIFFENER_B_LIST = [7 + i for i in range(10)]
STIFFENER_B_BOTTOM_LIST = [13 + i for i in range(5)]
